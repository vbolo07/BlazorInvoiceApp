...
namespace BlazorInvoiceApp.Repository
{
    public class AutoMapperProfile:Profile
    {
        public AutoMapperProfile()
        {
            ...
            CreateMap<InvoiceTermsDTO, InvoiceTerms>().ForMember(dest => dest.Id, opt => opt.Ignore());

            CreateMap<InvoiceLineItem, InvoiceLineItemDTO>();
            CreateMap<InvoiceLineItemDTO, InvoiceLineItem>().ForMember(dest => dest.Id, opt => opt.Ignore());
